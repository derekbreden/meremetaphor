...
async function buildSite() {
    console.log('Building site from PDF (fixed mobile CSS injection)...');
...
`;
            ...
            // Check for mobile-optimized styles using a specific marker
            if (!template.includes('/* MOBILE-OPTIMIZED-STYLES */')) {
                console.log('Adding mobile-optimized styles...');
                
                // Replace the entire style block with mobile-first styles
        ...
        @media print {
            ...
            .chapter-separator {
                ...
                console.log('Mobile-optimized styles already present, skipping...');
            }
